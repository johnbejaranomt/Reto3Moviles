...
import com.example.reto2.casos_uso.CasoUsoServicios;
...
public class ServiciosFragment extends Fragment {
    ...
    private CasoUsoServicios casoUsoServicios;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        try{
            casoUsoServicios = new CasoUsoServicios();
            dbHelper = new DBHelper(getContext());
            Cursor cursor = dbHelper.getData(TABLE_NAME);
            servicios = casoUsoServicios.llenarListaServicios(cursor);
